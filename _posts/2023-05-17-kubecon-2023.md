...
Next to the talks, there were also a large number of booths from companies from all over the world (AWS, Azure, Canonical, ...) to engage with other people and to talk and promote their newest products for the developer market.
With that being said, you can take a look at some of the talks we attended which we thought were very interesting.
You can click on the title of the talk to go to the recorded version on YouTube, which is provided by CNCF.
