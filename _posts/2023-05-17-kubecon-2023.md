...
Next to the talks, there were also a large amount of booths from companies from all over the world (AWS, Azure, Canonical, ...) to engage with other people and to talk and promote their newest products for the developer market.
...
They wanted to use something that supported MySQL since they had a plenty of MySQL experts employed and because they used MySQL before adopting Vitess.
...
# Conclusion
Kubecon was a very fun experience, and we got a load of interesting topics and talks.
Amsterdam was immensely beautiful and tourist friendly, with most of the residents speaking English fluently.
The RAI was a huge venue, as there was a lot of walking involved to travel from talk to talk.
It was a very crowded event, where some of the rooms where the talks were hosted were so packed that you had to attend the live stream as a result of no space.
Nevertheless, Kubecon was a great experience, and we can't wait until next year's edition.