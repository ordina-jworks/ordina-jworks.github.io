...
Later on it was discovered that light travels in particles, photons that have energy and momentum.

Two well know quantum algorithms are: 
...
All in all a very interesting talk to give you a headsup on the current state of affairs around quantum computing, but it also makes it quite clear that we still need to go a long way in order to have practical quantum computing.
