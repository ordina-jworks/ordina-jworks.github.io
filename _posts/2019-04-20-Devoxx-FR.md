...
For more info, see: [jeps/291](http://openjdk.java.net/jeps/291)

Java.se.ee and corba modules were removed in Java 11 as there were costly to maintain and a source of vulnerabilities.
Other obscure methods were removed in Java 9 such as a couple of `add/removePropertyChangeListeners` and lots of methods in SecurityManager
...
JDK 12: 8 JEPs
1 JEPs from another contributor (189)
...
If you’r eusing Java 9 or later, upgrade to the latest version of your tools and other dependencies.
