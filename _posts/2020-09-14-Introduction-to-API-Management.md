...
The gateway is actually middleware that is placed in front of your services and acts as a single entry point to administrate, 
route and secure your services.   
...
Before going into the details, let’s take a look on how most of the current API landscapes are build and how we can improve 
those with an API management tool.  
