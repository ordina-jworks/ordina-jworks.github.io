...
* [How to secure your Spring apps with Keycloak by Thomas Darimont](#how-to-secure-your-spring-apps-with-keycloak)
* [Zero Downtime Migrations with Spring Boot by Alex Soto](#zero-downtime-migrations-with-spring-boot)
...
[Andy Wilkinson](https://twitter.com/ankinson){:target="_blank" rel="noopener noreferrer"} of Pivotal explained us the importance and essence of writing tests in your application to ensure the quality of your services and to reduce the risk 
...
In this presentation [Thomas Darimont](https://twitter.com/thomasdarimont){:target="_blank" rel="noopener noreferrer"} talks about what Keycloak is,
...
together with a more in depth explaination of the covered topics in the video of the presentation below.
