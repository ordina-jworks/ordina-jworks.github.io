...
The key take away here is that although there’s an advantage in terms of architecture degradation,
(it’s harder to accidentally call another microservice than to call a method on another bounded context in a monolith),
this advantage certainly comes at a cost. You lose compile-time safety making it harder to refactor than a Monolith and it’s harder to test the whole system.
