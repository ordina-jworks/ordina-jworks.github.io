...
Nicolas Frankel is a Developer Advocate who works for Exoscale, which is a European cloud hosting provider.
...
But how do you know if a test is 'good'? Almost everything is based on the amount of code coverage in their project, while this does not determine the quality of your tests
...
## Event-Driven Microservices with Axon and Spring Boot: excitingly boring by [Allard Buijze](https://twitter.com/allardbz)
