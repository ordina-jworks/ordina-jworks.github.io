...
* [Jeroen Sterken & Wim: Moving an enterprise application to serverless](#moving-an-enterprise-application-to-serverless)
...
Is serverless the wholy grail? These guys explored the possibilities while migrating an existing monolith to serverless with one of their clients.  
