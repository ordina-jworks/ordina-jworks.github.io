...
<img alt="pickle rick" src="{{ '/img/2019-05-16-Spring-IO-2019/bad-architecture.png' | prepend: site.baseurl }}" class="image fit" style="margin:0px auto; max-width: 500px;">
...
First statement, it is dangerous to think of Kafka as a message queue.
As it tends to become a vine of data within your organization to move data around, it becomes a database.
