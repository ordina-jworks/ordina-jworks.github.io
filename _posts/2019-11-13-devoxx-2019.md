...
In this talk [Mey Beisaron](https://twitter.com/@ladymeyy) explained how she learning [Clojure](https://clojure.org/).
...
After the book the [4clojure website](http://www.4clojure.com/) is a good source of exercises you can follow.

But she still felt that that wasn't enough to understand the language completely.

Some years ago, fFor Java, she was able to learn it in 1 weekend, by writing a simple 2D game.
