...
[Apache Pulsar](https://pulsar.apache.org/en/){:target="_blank" rel="noopener noreferrer"} is a pub sub messaging systemt built on top of [Apache Zookeeper](https://bookkeeper.apache.org/){:target="_blank" rel="noopener noreferrer"}.
...
Currently a proxy just handles outside communication with the brokers, but there is a proposal [PIP-46](https://github.com/apache/pulsar/wiki/PIP-46:-Next-gen-Proxy){:target="_blank" rel="noopener noreferrer"} to let it handle much more, including dealing with the Kafka binary protocal and MQTT.
...
[<span class="image left"><img class="p-image" alt="Nick Van Hoof" src="/img/author/nick-van-hoof.jpg"></span>](https://ordina-jworks.github.io/author/nick-van-hoof/){:target="_blank" rel="noopener noreferrer"}
