...
One thing that didn't make the project due to the tight deadline is testing on front-end part. This is ofcourse really important but in 4 weeks we had to do the best possible for the development. It is easy to even now add the tests to the application since it is a part of what angular-cli set-ups when creating a new project.
