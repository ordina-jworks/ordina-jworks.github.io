...
* Going Cloud Native with Spring Cloud Azure by Bruno and Josh
* Google Cloud Native with Spring Boot by Ray and Josh
* Kubernetes Patterns by Ronald Huss
* Getting started with Spark by Nikhil Nanivadekar
* Performance tuning Twitter services with Graal and Machine Learning by Chris Thalinger
* Fn Awesome: Open Source Foundation by Shaun Smith
