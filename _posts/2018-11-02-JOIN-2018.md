...
Of course if you're using a different light source colors are perceived differently by the camera (e.g. the same color in fluorescent lighting is green while it will be matched to yellow when using a light bulb). 
...
Very soon this will scale up to 5% of all TVH customers which amounts to 3000, after that there will be a gradual ramp up towards 20 000 customers.
