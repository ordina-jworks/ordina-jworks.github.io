---
layout: post
authors: [dieter_hubau, yannick_de_turck, tom_van_den_bulck , johan_silkens, jens_bosman]
...
If a thread is idle it can take over execution of tasks that were originally executed by a different thread.
