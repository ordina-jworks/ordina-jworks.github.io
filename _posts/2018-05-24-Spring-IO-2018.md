...
Reactor is concurrency agnostic, this means it doesn't impose a concurrency model, it does give the developer the tools to change Reactor's executor behaviour however.
