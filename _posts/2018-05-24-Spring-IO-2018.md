...
This was the category where James gave the most examples of during his talk . Supervised learning is where you train your model with a data set wich contains the inital data and it's correct answers.

An example he showed us was the prediction of house prices using regression.
<img class="p-image" alt="House price prediction (From Andrew Ng Learning course)" src="/img/spring-io-2018/houseprice.png" class="image fit">
<small class="center">(From Andrew NG's Machine learning course)</small>

In this example, the data set consists of instances with a square footage (input) and price (output). With a regression, we can predict a continuous valued price. The more instances you have, the more accurate your price predictions will be.

TODO Add classification example

Another example of Supervised Learning is to determine a certain species of an Iris. Your algorithm must try to determine the species with the Sepal and Petal size of a flower as input.  
