...
Java 9 brings new update cycle
...
Oracle leads the first six months of the OpenJDK LTS code line,
...
Red Hat is currently leading OpenJDK 8 and OpenJDK 11 since April.
...
\* **Major** = Linux x86, Mac OS x, Windows x64,
