...
On the 4th of October the JOIN event was organised for the 6th time.

JOIN is a free conference hosted every year by [Ordina Jworks](https://ordina-jworks.github.io/), by and for the own employees.
...
In this blog post I will summarize the various talks I attendented.

****

<img class="image fit" src="{{ '/img/join-2018/join-boss.jpg' | prepend: site.baseurl }}" alt="Join 2018 Happy Chief" />

****

<img class="image fit" src="{{ '/img/join-2018/join-food.jpg' | prepend: site.baseurl }}" alt="Join 2018 Food" />

****

<img class="image fit" src="{{ '/img/join-2018/join-crowd.jpg' | prepend: site.baseurl }}" alt="Join 2018 Food" />

****

<img class="image fit" src="{{ '/img/join-2018/accelerator.jpg' | prepend: site.baseurl }}" alt="Join 2018 Food" />
...
<span class="image left"><img class="p-image" alt="Frederick Bousson" src="/img/author/frederick-bousson.jpg"></span>
...
<img class="image fit center" alt="XX" src="/img/join-2018/TVH.png">
...
#### Riff
A new version was released 2 weeks ago, since this is a very fresh and new project this does mean a lot of late nighters to migrate your code.
Backwards compatibility is currently not (yet) a requirement.

Its name is derived from the guitar world.
The project lead is [Mark Fisher](https://www.twitter.com/m_f_)
...
This means that around 160 000 calls will be sent to the backend to do the calculation.
Not the most efficient way to do the calculation, but this demo is about using functions not about calculating a Mandelbrot really fast.
...
<img class="image fit center" alt="XX" src="/img/join-2018/HZIV_logo.png">
HZIV is a governement health agency which offers its members legal health and disability insurance.

### What 

A lot of old applications still run with the [Cobol](https://en.wikipedia.org/wiki/COBOL).

10 years ago HZIV wanted to rewrite these using Java 5 and Swing, but that rewrite didn't go so well.

### A new start
With more time comes more insight and it was decided to do a new rewrite.

Chosen technologies were:
* Java 8 & 10
* [MongoDB](https://www.mongodb.com/)
* [ELK](https://www.elastic.co/elk-stack)

The teams were also given more freedom in how to setup their development environment and choose the technologies.
...
As a product owner you should be able to explain your product in 3 minutes.
...
[<img class="image fit center" alt="XX" src="/img/join-2018/designStaminaGraph.gif">](https://martinfowler.com/bliki/DesignStaminaHypothesis.html)
...
Know how to validate your assumptions, make sure that you have a good feedback loop.
...
If they get stuck you need to ask them why.
...
Another big no-no is a 'definition of done' which is more then 1 page long.

A nice concept is the 3 Cs 
* Card (post it - fat pen): this is a reminded that we need to talk about this
* Criteria: Only Acceptance Criteria on the story.
* Conversation: during refinement and then you will expand the story.
