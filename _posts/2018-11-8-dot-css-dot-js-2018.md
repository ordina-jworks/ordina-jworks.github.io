...
Although all talks are mentioned, we don't elaborate on all of them. You can find all talks on the [YouYube channel](https://www.youtube.com/user/dotconferences){:target="_blank" rel="noopener noreferrer"} of dotConferences.
...
1. [Day 1: dotCSS](#day-1-dotcss)
    1. ['Line Breaks' by Florian Rivoal](#line-breaks-by-florian-rivoal)
    1. ['Power of SVG' by Sara Soueidan](#power-of-svg-by-sara-soueidan)
    1. ['i18n: A Brief Primer of Web Internationalization' by Elika J. Etemad](#i18n-a-brief-primer-of-web-internationalization-by-elika-j-etemad)
    1. ['Reading Hex codes' by David DeSandro](#reading-hex-codes-by-david-desandro)
    1. ['CSS at the intersection of mental models' by Natalya Shelburne](#css-at-the-intersection-of-mental-models-by-natalya-shelburne)
...
He explains the logic of the system, different ways the properties can be used to achieve various results, and looks into some of the complication caused by incomplete implementations.

[View talk](https://www.dotconferences.com/2018/11/florian-rivoal-line-breaking){:target="_blank" rel="noopener noreferrer"} | [View slides](https://florian.rivoal.net/talks/line-breaking/){:target="_blank" rel="noopener noreferrer"}
...
[View talk](https://www.dotconferences.com/2018/11/elika-j-etemad-i18n-in-css){:target="_blank" rel="noopener noreferrer"} | [View slides](http://fantasai.inkedblade.net/style/talks/i18n-primer/){:target="_blank" rel="noopener noreferrer"}
...
> CSS exists at an intersection between mental models. 
How do we know? 
Because we keep hearing the same endless debate: "Is CSS broken or awesome?"
...
[View talk](https://www.dotconferences.com/2018/11/natalya-shelburne-css-at-the-intersection){:target="_blank" rel="noopener noreferrer"} | [View slides](https://docs.google.com/presentation/embed?id=1Cj67a-wU1xDIUiBSx9T5ojzMGXTskA8mvx1DslYBCjg&start=false&loop=false){:target="_blank" rel="noopener noreferrer"}
...
The survey contains data from over 20000 developers from all around the globe and you can find the results on their 
...
<img class="image fit" alt="#D49B25 color described as Middle Washed Orange" style="max-width: 50%" src="/img/2018-11-08-dot-css-dot-js-2018/stateofjs-fe-results.png">
