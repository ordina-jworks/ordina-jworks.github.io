...
5. [In the spotlight - Ghelamco alert](#in-depth-on-talk-Ghelamco-alert)
6. [In the spotlight - Some pitfalls of AI](#in-depth-on-talk-some-pitfalls-of-ai)
...
<tbody>
<tr>
<td style="vertical-align:top;"><p></p><p>Company: Amazon Web Services</p></td>
...
<tbody>
<tr>
<td style="vertical-align:top;"><p></p><p>Company: Agile &amp; Learning Beyond Borders</p></td>
...
This talk features the awesome Internship project by Kevin Govearts which is a shining example of and end-to-end integrated IoT project.
...
If the model handles text the gender is actually also encoded in the vocabulary and way of speaking, it is very different between women and men.
...
- Adversarial attacks
  - Changing a few pixels in an image might throw of the model completely
...
- [Smalls Research](https://www.smalsresearch.be/){:target="_blank" rel="noopener noreferrer"}
