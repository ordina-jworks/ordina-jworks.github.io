...
* **Analyzing risks and cross-functional requirements.**
	...
	* What will the impact on the project be when taking a certain risk. 
	Eg. introducing new technology you saw at a conference.
...
* **Bridging communication between stakeholders and the team.**
	* Business stakeholders are often less technical in nature then developers. 
...
I will also elaborate on the reasoning for these remarks and for the choices the made.
...
And excellent book on this, is [Liminal Thinking](http://liminalthinking.com/) by Dave Gray.
...
I mentionned this before: everybody is part of the team and everybody's opinion should be valued.
...
Thish is not the fastest time _you_ can possibly do something, in the best possible conditions. 
