...
Either an integration with your Git repository or a CLI tool can be used to get the source strings onto Crowdin.
...
It will warn you if they are translated and they no longer match the original tags/names.
...
## Getting started
### Account
To start using Crowdin, you of course need an account at [Crowdin.com](https://crowdin.com). 
...
For Windows an [installer](https://support.crowdin.com/cli-tool/) is available.
...
> There are [more options](https://support.crowdin.com/configuration-file/) and regexes available, but these are the only ones required to set up Crowdin in an Angular app for example.
...
A great benefit of this, if you can convince the people you need to convince, 
is that your stories don't have to wait for all translations to be done.
...
You will also be able to edit the translations inline in your application and they will immediately be reflected on Crowdin.com.
...
Now, this isn't something you want to do on your production environment.
...
More info [here](https://support.crowdin.com/in-context-localization/).
