...
> Apart from the conference, xHub also offered a speakers trip to the speakers.
...
Instead, he prefers it when the community stands as one behind the framework. 
...
He looked for other frameworks and stumbled upon [MockK](https://mockk.io){:target="_blank" rel="noopener noreferrer"}, a mocking framework specifically created for Kotlin by [Oleksiy Pylypenko](https://github.com/oleksiyp){:target="_blank" rel="noopener noreferrer"}.
