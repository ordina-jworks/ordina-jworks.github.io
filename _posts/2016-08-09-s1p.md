...
image: /img/s1p.jpg
tags: [Security, Spring, Cloud Foundry, Las Vegas, Cloud, Spring Cloud, Pivotal]
category: Conference
comments: true
---
...
As a [Secure-By-Design](https://www.ordina.be/themes/security-and-privacy/) company, this talk immediately caught my attention. In a Spring world, we can use [Spring Cloud Vault Config](https://github.com/spring-cloud-incubator/spring-cloud-vault-config), wrapping [Vault](https://www.vaultproject.io/). An interesting tutorial on this Spring library is available on [spring.io](https://spring.io/blog/2016/06/24/managing-secrets-with-vault).  
