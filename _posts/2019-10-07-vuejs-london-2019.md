...
* [VueVixen's workshop: hands-on with the Composition API](#vuevixens-workshop-hands-on-with-the-composition-api-by-vue-vixens)
...
An excellent code example of this can be found on [Ramona's GitHub](https://github.com/CodesOfRa/d3-vue-graph/blob/master/src/components/Tree.vue){:target="_blank" rel="noopener noreferrer"} with the [live application available online](https://outofmylens-flowers.netlify.com/){:target="_blank" rel="noopener noreferrer"}. The [slides of her talk](https://slides.com/codesofra/data-visualization-in-2#/){:target="_blank" rel="noopener noreferrer"} are also online.
