...
Before noon, a total of 5 talks was planned with topics ranging from animations, styling, visualisations and performance to the future of the Vue router.
...
With the help of the [Cypress Cucumber preprocessor](https://github.com/TheBrainFamily/cypress-cucumber-preprocessor){:target="_blank" rel="noopener noreferrer"} Callum was able demonstrate how code like this could be processed by Cypress:
