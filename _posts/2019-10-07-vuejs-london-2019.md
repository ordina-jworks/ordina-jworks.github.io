...
* [VueJS London 2019: time to get hyped about Composition API and Vue3](#vuejs-london-2019-time-to-get-hyped-about-composition-api-and-vue3)
...
## VueJS London 2019: time to get hyped about Composition API and Vue3
...
> [View slides](https://slides.com/mayashavin/css-in-js-the-good-the-bad-and-the-ugly/fullscreen#/)
...
> An example implementation can be found on [Callum's GitHub](https://github.com/csi-lk/cypress-gwt-example){:target="_blank" rel="noopener noreferrer"}
...
The website will keep on growing with new project types and packages added regularly.
...
> Maria's [repository for her talk](https://github.com/mlama007/FocusManagement){:target="_blank" rel="noopener noreferrer"}
...
> Rolf's [repository for his talk](https://github.com/vueschool/application-shortcuts){:target="_blank" rel="noopener noreferrer"}
...
If we would colour code every feature in our code, a component in the Options API with a lot of features would end up having elements of the same feature all over the component.

<p class="align-center">
  <img src="{{ '/img/vuejs-london-2019/options-api-vs-composition-api.png' | prepend: site.baseurl }}" class="image fit" alt="Comparison of Options API and Composition API with each feature colour coded">
</p>
...
Each colour in the image above can thus be potentially extracted into separate functions.
...
> [View slides](https://github.com/LinusBorg/talks/raw/master/2019-10-04%20Vuejs%20London/New%20composition%20API%20%20-%20Vue.js%20London%202019-10-04.pdf){:target="_blank" rel="noopener noreferrer"}
...
> [The source code is on his GitHub](https://github.com/ycmjason-talks/2019-10-04-vuejs-london-conference-2019){:target="_blank" rel="noopener noreferrer"} and a screen capture can be found on [YouTube](https://www.youtube.com/watch?v=_K5zbgJ_z9w){:target="_blank" rel="noopener noreferrer"}
...
<p class="align-center">
  <img src="{{ '/img/vuejs-london-2019/vuevixens-workshop.jpg' | prepend: site.baseurl }}" class="image fit" alt="The people who attended the VueVixens workshop">
</p>

// TODO: more text with mention to Boston Vue.js Co-Organizer Kristin Ruben and Raleigh-Durham Chapter Leader Maria Lamardo

> [VueVixens website](https://vuevixens.org){:target="_blank" rel="noopener noreferrer"}
