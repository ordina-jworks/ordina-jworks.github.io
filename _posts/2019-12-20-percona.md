...
<img class="image fit" src="{{ '/img/2019-12-20-percona/mysql.png' | prepend: site.baseurl }}" alt="Mysql" />

<div style="text-align: center;" >
  <img src="/img/2019-12-20-percona/mysql.png" width="60%">
</div>
...
<img class="image fit" src="{{ '/img/2019-12-20-percona/mariadb.png' | prepend: site.baseurl }}" alt="MariaDB" />
