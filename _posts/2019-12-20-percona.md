...
* <B>Why PostgreSQL is Becoming A Migration Target in Large Enterprises</B>
	...
	*Integration with Other RDBMS systems, Oracle, MSSQL, and MySQL
	Integration with Hadoop and NoSQL databases
    Compatibility layer: Example of OraFCE 4. Migration tools: Example of Ora2Pg
    How PostgreSQL is suitable for Agile development and Knowledge Portability. 6. PostgreSQL 	derived projects and freedom of choice.*
