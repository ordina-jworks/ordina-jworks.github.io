...
The first keynote was particularly interesting to see the results of the The Open Source Data Management Software Survey Percona conducted in the run-up to the conference. More insights can be fount in the [Open Source Data Management Software Survey](https://learn.percona.com/hubfs/Percona_Open_Source_DataManagement_Software_Survey_2019.pdf?__hstc=221416967.b5bed1057192b82e1b3e510771501218.1569922151538.1583767811856.1583848866284.9&__hssc=221416967.1.1583848866284)

For good insights into how the open source database landscape is evolving, we can rely on various sources.
...
PostgresSQL has been around for more than 20 years and its popularity is still growing. More, according to DB engines that measures the popularity of databases, PostgreSQL now ranks fourth among the most popular databases, after Oracle, MySQL and Microsoft SQL Server and it was referred to as 'Database of the year' in both 2017 and 2018. In 2019 it had to pass on this title to MySQL.
...
<BR>
Although the focus of the conference was on MySQL, Postgres was also well represented at the conference with more than 37 talks on the subject. Because of the increasing popularity in recent years and because many developers think it is the coolest database out there, I preferred these sessions.
...
* [MariaDB Security Features and Best Practices%](https://www.percona.com/live/19/sites/default/files/slides/MariaDB%20Security%20Features%20and%20Best%20Practices%20-%20FileId%20-%20187568.pdf)
