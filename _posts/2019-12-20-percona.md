...
<img class="image fit" src="{{ '/img/2019-12-20-percona/stackoverflow.png' | prepend: site.baseurl }}" alt="Stackoverflow" width="80%" />
...
## PostgreSQL
 ...
 <span class="image left"><img src="/img/2019-12-20-percona/postgres.jpeg" width="100" height="100"></span>
