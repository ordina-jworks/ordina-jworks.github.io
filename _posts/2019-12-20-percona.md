...
Also for MariaDB we can deduce from the graph that the popularity of the database is still increasing. There were only a handful of sessions on Mysql's fork at the conference. 
