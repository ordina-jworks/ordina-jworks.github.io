---
layout: post
authors: [yannick_de_turck, pieter_van_hees]
...
Functional programming is easier in Kotlin because functions are so called first-class citizens.
They use a third party library called [arrow-kt.io](https://arrow-kt.io) to enhance the functional capabilities of the language.
This is similar to the [Vavr](https://www.vavr.io/) library for Java developers.
It adds operations such as 
...
The examples have not been cut and paste from Java but they also take in to account the Kotlin idioms and DSLs.
...
Since a few months, the [Spring Initializer](https://start.spring.io) project also supports Gradle with Kotlin DSL.
...
* [Spring Security DSL](https://github.com/spring-projects-experimental/spring-security-kotlin-dsl) by Eleftheria Stein
...
* Spring MVC DSL and functional API
    * Router DSL is now available for both Spring MVC and Spring WebFlux. A quick example:
