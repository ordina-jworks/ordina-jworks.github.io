...
### Language evolutions
It is important for JetBrains to keep the language modern although they are aware that it is not very desired to have your code broken in between updates.
...
### 3. Proof of Concept
Don't only talk about your passion.
...
You have to take into account version control, chat applications for communicating, write documentation and issue tracking.
...
It is the fault of the culture and of the system.
