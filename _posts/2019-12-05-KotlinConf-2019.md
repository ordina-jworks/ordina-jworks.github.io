...
Big kuddos for Sébastien Deleuze for thinking about the environment.
...
One of the most popular data science tools is Jupyter.
...
Roman also shows the integration fo Kotlin with Apache Spark, a popular framework for analyzing big data.
It is usually used with Scala or Python, but can also be used with Kotlin.
He goes on to demonstrate Spark on Apache Zeppelin (a notebook like Jupyter) as well, for which he wrote a Kotlin interpreter.
It's also possible to connect to a Zeppelin server in IntelliJ and do most of the things in your favourite IDE instead of on the web-based notebook.
...
Jake Wharton takes a look into the future and see what features Java could have in 2022, which is when Java 19 will be released, and compares it with the current state of Kotlin.
...
# Summing it all up
There was a nice variety of interesting talks to choose from.
...
The venue, The Bella Center, was also very nice and it was pretty convenient having a hotel room in there.
