...
> In this blogpost we want to give the highlights of some of the talks be followed.
...
JAX is all about "openess", we should be celebrating open source and embrace open source thinking as it makes our code smarter.
...
* Pioneers: They go into the wild and experiment and although they might fail often, they're looking at what the next thing might be
...
After the migration they managed to sustain peaks of TPS (Tweets Per Second) for hours.
...
- Make people responsible for their on Quality Assurance
...
Chris talked about the problems you have to deal with when dealing with microservices and that practicing Domain-Driven Design can help you a lot to address these.
...
- Least privilege
    ...
    - Tradeoff: It is less convenient, less efficient and more complexity
...
- Trust cautiously
    ...
    - Example: Dont accept untrusted RMI connections, use client certificates, credentials or network controls
- Simplest solution possible
    - Why: Security requires understanding of the design, complex design is rarely understood, simplicity allows analysis
    - Principle: Actively design for simplicity - avoid complex falure modes, implicit behaviour, unnecessary features,…
...
Serverless or FaaS might actually be the next step in the evolution.

Going serverless will lead to less worries seeing as you no longer have the server management to look out for.
...
- IBM Bluemix OpenWhisk
	...
	- The most mature solution available
	- Better UI than AWS and also has a dashboard for monitoring
- MS Azure Cloud Functions
	- Mature system
	- Different paymodel compared to AWS that could be more expensive in the long run
- Google Cloud Functions
	- Development by Google started 5 years ago
	- Currently reimplementing it
	- Currently in prime-alpha for which an NDA applies
- Auth0 WebTask
	- CLI
...
Bart did a demo consisting on an Arduino measuring the temperature.
