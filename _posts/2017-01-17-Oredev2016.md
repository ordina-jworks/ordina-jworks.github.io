...
This blog post will be about the talks I favored and where I learned the most from and still use in my nowadays projects.
...
Software is build into two parts, it is what we see and how we do it.
...
At last they categorized every piece into 'Tenets' (Attributes of good user interfaces) and 'Traps' (Bloopers and things to avoid)
...
The best way to buy 10 milk boxes is to scan the milk 10 times than to write it down 10x with your other hand.
