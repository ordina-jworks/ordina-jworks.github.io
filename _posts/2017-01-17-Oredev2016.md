...
The best way to buy 10 milk boxes is to scan the milk 10 times than to write it down 10 times with your other hand.
...
A bad practice for example is that after you just filled in a form, clicked through to the next page and tried to go back to the form to add some missing information only to find out that your form has been completely reset.
Habituating
----------------------
