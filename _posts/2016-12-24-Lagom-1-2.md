...
TODO Question remains: is Lagom worth adopting right now?
TODO Would you trust Lagom in its current state to be rolled out in your company?
TODO According to Lightbend, Lagom usage is already ramping up and they are seeking for people to help them provide support to developers.
TODO I personally think it's worth it if you go with the Reactive Platform license. I've seen a couple of users on Gitter trying to deploy their test application using Zookeeper and Kubernetes but as far as I can see it's still experimental. Feedback of Lightbend on this part would be useful here.
